...
let cursor_tracker = document.querySelector(".cursor_tracker")
document.addEventListener("mousemove", function(e){
  
  /*console.log("move", e.pageX, e.pageY, cursor_tracker.style.color)*/
  tX = e.pageX 
  tY = e.pageY 
  cursor_tracker.style.top = `${tY+10}px`;
...
Tool.forEach(el =>{
  el.addEventListener("mouseover" ,function(){
    cursor_tracker.innerHTML = el.dataset.name
    cursor_tracker.style.display = "inline-block"
  })
  el.addEventListener("mouseout" ,function(){
    cursor_tracker.innerHTML = ""
